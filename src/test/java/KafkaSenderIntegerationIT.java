 ...
 * 
 * import com.javainuse.SpringBootHelloWorldApplication; import
 * com.javainuse.service.KafkaSender; import
 * com.javainuse.service.MessageBinding; import
 * com.javainuse.service.kafkaReciever; import
 * com.javainuse.service.kafkaReciever.MessageRequest;
 * 
 ...
 * "spring.kafka.bootstrap-servers=kafka:9092" }) public class
 * KafkaSenderIntegerationIT {
 * 
 * @Autowired private KafkaSender sender;
 * 
 * @Autowired kafkaReciever kafkaReciever;
 * 
 * 
 ...
 * 
 * 
 * @Test public void send() throws InterruptedException {
 * 
 * 
 * String data = "IntegrationTest12345"; MessageRequest req = new
 * MessageRequest(data); System.out.println("==========send test method====");
 * boolean b = sender.send(req); Thread.sleep(3000);
 ...
 * System.out.println("==========Before End===="); Assert.assertTrue(b);
 * System.out.println("==========End===="); send2(); }
 * 
 ...
 * @Test
 * 
 * @StreamListener("InputCommonChannelTest") public void send3() {
